...
class ClientPrefs
{
	...
	public static var songPlayed:Map<String, Bool> = [
		"disheartened" => false,
		"numbskull" => false,
		"fractured-incantation" => false,
		"divine-punishment" => false,
		"purgatory" => false,
		"charlatan" => false,
		"atmospherical" => false,
		"nemesis" => false,
	...
	public static var pauseMusic:String = 'Take a Break';
	...
	public static function saveSettings()
	{
		...
		FlxG.save.data.songPlayed = songPlayed;
	...
	public static function loadPrefs()
	{
		...
		if (FlxG.save.data.songPlayed != null)
		{
			songPlayed = FlxG.save.data.songPlayed;
		}
