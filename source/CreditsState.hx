...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['TeeJay',              'tee',              'Sprite Animator',                                                              'https://www.youtube.com/channel/UChV3iaDk2iEyLrkUrF6m0vA',               'ecb283'],
			[''],
			['EC Contributors'],
			...
			['Zmac',                'blank',            'Zander Backgrounds',                                           'https://www.youtube.com/channel/UCl50Xru1nLBENuLiQBt6VRg',               'FFFFFF'],
			...
			['Capp',                'blank',            'Original Multicharacters Script',                              'https://www.youtube.com/channel/UCRtVgylcM-jpxJN2UqWcbMg',               'FFFFFF'],
