...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		etaText = new FlxText(leftArrow.x + 90, rightArrow.y + 140, 0, "", 44);
		etaText.alignment = RIGHT;
		etaText.font = rankText.font;
		etaText.color = 0xffffffff;
		add(txtTracklist);
		add(etaText);
		// add(rankText);
		add(scoreText);
	...
	function changeWeek(change:Int = 0):Void
	{
		...
		etaText.text = "ETA: " + etas[curWeek] + "m";
