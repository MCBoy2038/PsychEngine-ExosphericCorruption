...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		else if (FlxG.save.data.gorestuff == null && !GoreWarningState.leftState)
		{
			FlxTransitionableState.skipNextTransIn = true;
			FlxTransitionableState.skipNextTransOut = true;
	...
	override function beatHit()
	{
		...
		if (!closedState)
		{
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['The Exospheric Team'], 15);
					#else
				...
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('Exospheric Corruption'); // credTextShit.text += '\nFunkin';
